...
namespace KiteBotCore.Modules
{
    public abstract class CleansingModuleBase : ModuleBase
    {
        ...
        {
            var output = message.Replace("@​everyone", "@ everyone").Replace("@ here", "@he\x200Bre").Replace("@", "@ ");
            //var output = message.Replace("@​everyone", "@every\x200Bone").Replace("@here", "@he\x200Bre").Replace("@", "@\x200B");
